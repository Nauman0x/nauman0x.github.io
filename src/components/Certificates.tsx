...
export const Certificates: React.FC = () => {
  return (
    <section id="certificates" className="py-24 bg-[#EDE9F8] border-t-[3px] border-black relative">
            ...
            return (
              <Reveal key={cert.id} delay={idx * 80}>
                <a
                  ...
                  className="group flex flex-col justify-between bg-white border-[3px] border-black p-5 hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all h-full"
                >
                  <div>
